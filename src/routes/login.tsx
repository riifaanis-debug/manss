  ...
  return (
    <div className="min-h-screen flex flex-col" dir="rtl">
      ...
      <div className="flex-1 bg-zinc-950 flex items-start justify-center px-4 pt-8">
        ...
        >
          {/* Toggle Tabs */}
          <div className="flex mb-4 bg-zinc-900 border border-zinc-800 rounded-xl p-1">
            <button
              type="button"
          ...
          <form onSubmit={handleSubmit} className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 shadow-2xl space-y-4">
            ...
            <button
              ...
              className={`w-full font-bold rounded-xl py-3 transition-all shadow-lg disabled:opacity-50 ${
                loginMode === "admin"
                  ? "bg-gradient-to-l from-violet-500 to-indigo-600 text-white hover:from-violet-400 hover:to-indigo-500 shadow-indigo-600/20"
                  : "bg-gradient-to-l from-sky-500 to-blue-600 text-white hover:from-sky-400 hover:to-blue-500 shadow-blue-600/20"
              }`}
            >
